...
const Projects = () => {
  ...
  return (
    <motion.div
      ...
      className="flex relative flex-wrap max-w-screen-xl h-fit gap-20 mb-20 mx-auto items-center justify-center  data-scroll-section"
    >
...
const Contact = () => {
  ...
  return (
    <div className="bg-gray-200 rounded-t-[60px]  data-scroll-section">
      <motion.div
        id="contacts"
        // style={{ scale }}
        ...
        <div className="grid gap-4 justify-center mt-20">
          ...
          <ul className="md:flex grid justify-center gap-6 md:gap-20 text-black text-4xl mx-auto mt-10 pb-5">
            <MagneticEffect>
          ...
          <div className="grid md:flex gap-10 justify-center mt-10 justify-items-center">
            <MagneticEffect>
